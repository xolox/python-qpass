"""Documentation build configuration file for the `qpass` package."""

import os
import sys

# Add the 'qpass' source distribution's root directory to the module path.
...
from qpass import __version__ as qpass_version  # noqa

# The short X.Y version.
version = '.'.join(qpass_version.split('.')[:2])

# The full version, including alpha/beta/rc tags.
release = qpass_version
